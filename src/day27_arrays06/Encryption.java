...
public class Encryption {
    public static void main(String[] args) {
        ...
        String word="java";
        String encWord="";
        //encryp this. 4 letters in word. no loop please
        ...
        for (int i = 0; i <word2.length(); i++) {
            ...
            //4. add enc to encrytptedWord variable
            encryptedWord+=enc;
        ...
        for (int i = 0; i <word3.length() ; i++) {
            char verbs=word3.charAt(i);
            int index=encrypted.indexOf(verbs);
            char alp=alphabet.charAt(index);
            alpverb+=alp;
        }
        System.out.println("alpverb = " + alpverb);        }
    }
