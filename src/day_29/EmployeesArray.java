...
public class EmployeesArray {
    public static void main(String[] args) {
        ...
        //TASK 1. Print all job titles use substrings, indexof
        ...
        /*
        Tracy Bartle [Geological Enginneer]
        ...
        for (String emp : employees) {
            ...
            if (first.equals("Tracy") && last.equals("Bartle")) {
                if (job.equals("Geological Engineer")) {
                    System.out.println("PASS: Verification successful. Tracy Bartle's job Geological Engineer");
                } else {
